            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap5">
                        <table id="myreport_table" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example_info">
                            <thead>
                                <tr role="row">
...
@include('event.layout.footer')
    ...
    $(function () {
          var table = $('#myreport_table').DataTable({
              processing: true,
              serverSide: true,
              ajax: "/report/myreport",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'title', name: 'title'},
                  {data: 'newdescription', name: 'newdescription'},
