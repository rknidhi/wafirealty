				...
				<li class="menu-label">Dashboard</li>
					...
					<li>
						...
						<ul>
							...
							<li> <a class="has-arrow" href="#">Manege Brand</a>
								<ul>
									<li> <a href="/brand/list"><i class="bx bx-right-arrow-alt"></i>All Brand</a></li>
									<li> <a href="/brand/add"><i class="bx bx-right-arrow-alt"></i>Add Brand</a></li>
									<!-- <li> <a href="javascript:();"><i class="bx bx-right-arrow-alt"></i>Edit Blogs</a></li> -->
									<!-- <li> <a href="javascript:();"><i class="bx bx-right-arrow-alt"></i>Delete Blogs</a></li> -->
							...
							<li> <a class="has-arrow" href="#">Manege Projects Types</a>
								<ul>
									<li> <a href="/projecttype/list"><i class="bx bx-right-arrow-alt"></i>All Project Types</a></li>
									<li> <a href="/projecttype/add"><i class="bx bx-right-arrow-alt"></i>Add Project Types</a></li>
									<!-- <li> <a href="javascript:();"><i class="bx bx-right-arrow-alt"></i>Edit Blogs</a></li> -->
									<!-- <li> <a href="javascript:();"><i class="bx bx-right-arrow-alt"></i>Delete Blogs</a></li> -->
									<!-- <li> <a href="javascript:();"><i class="bx bx-right-arrow-alt"></i>Trash Projects</a></li> -->
								</ul>
