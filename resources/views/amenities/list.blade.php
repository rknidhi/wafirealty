            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">All Project Amenities</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap5">
                        <table id="project_amenities_table" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example_info">
                            <thead>
                                <tr role="row">
...
@include('event.layout.footer')
    ...
    $(function () {
          var table = $('#project_amenities_table').DataTable({
              processing: true,
              serverSide: true,
              ajax: "/projectamenities/list",
              columns: [
                  {data: 'id', name: 'id'},
