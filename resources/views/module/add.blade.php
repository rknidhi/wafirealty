...
<div class="page-wrapper">
    ...
    @include('event.layout.alert')
        ...
        <div class="card">
      <div class="card-body">
            <form action="/module/create" id="addtestimonials" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                <input type='hidden' name='id' value='<?php if(isset($module) && $module['id']!=''){echo $module['id'];}?>'/>
                <div class="col-12 col-lg-6">
                  <label for="" class="form-label">Title</label>
                  <input type="text" required class="form-control" id="module" 
                  value="<?php if(isset($module) && $module['name']!=''){echo $module['name'];}?>" placeholder="Blog Title" name="name">
                </div>
                <div class="col-12 col-lg-6">
                  ...
                  <select class="form-select" id="InputLanguage" aria-label="Default select example" name="status">
                    ...
                    <option value="active" <?php if(isset($module) && $module['status']=='active'){echo 'selected';}?>>Active</option>
                    <option value="inactive" <?php if(isset($module) && $module['status']=='inactive'){echo 'selected';}?>>Inactive</option>
                  </select>
                </div>
                </div>
                <div class="row">
