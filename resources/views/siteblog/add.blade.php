...
<div class="page-wrapper">
    ...
    @include('event.layout.alert')
        ...
        <div class="card">
      <div class="card-body">
            <form action="/siteblog/create" id="addtestimonials" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <?php 
                if(isset($blogs) && $blogs['filepath']!='')
                {
                  ?>

                  <div class="col-12 col-lg-6">
                  <a href="<?php echo URL::asset($blogs['filepath']); ?>">  <label for="" class="form-label mt-4"><?php if(isset($blogs) && $blogs['filepath']!=''){ $filename = explode('/',$blogs['filepath']); echo end($filename);}?></label></a>
                ...
                <div class="col-12 col-lg-6">
                  ...
                  <input type="text" required class="form-control" id="title" 
                  value="<?php if(isset($blogs['metadata']) && $blogs['metadata']!=''){echo $blogs['metadata'];}?>" placeholder="Meta Title" name="metatitle">
                </div>
                <div class="col-12 col-lg-6">
                ...
                <div class="col-12 col-lg-6">
                  ...
                  <select name="siteid" id="siteid" class="form-control select2">
                    {!!$siteoption!!}
                  </select>
                </div>
